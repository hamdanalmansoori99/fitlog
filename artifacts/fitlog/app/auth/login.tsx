    ...
    >
      ...
      >
        ...
        <View style={styles.logoSection}>
          <View style={[styles.logoCircle, { backgroundColor: theme.primaryDim, borderColor: theme.primary }]}>
            <Feather name="activity" size={36} color={theme.primary} />
          </View>
...
const styles = StyleSheet.create({
  ...
  logoSection: { alignItems: "center", marginBottom: 48, gap: 12 },
  logoCircle: {
